      ...
      <main className="min-h-screen bg-neutral-50 text-neutral-900">
        ...
        <header className="sticky top-0 z-40 backdrop-blur bg-white/80 border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
            <a href="#top" className="flex items-center gap-3 group">
              <div className="w-10 h-10 rounded-2xl bg-black text-white grid place-items-center font-bold tracking-wide group-hover:scale-105 transition">
                SO
              </div>
            ...
            <nav className="hidden md:flex gap-6 text-sm">
              <a className="hover:text-black/80" href="#tjanster">
                Tjänster
              </a>
              <a className="hover:text-black/80" href="#process">
                Process
              </a>
              <a className="hover:text-black/80" href="#priser">
                Priser
              </a>
              <a className="hover:text-black/80" href="#kontakt">
                Kontakt
              </a>
            </nav>
            <div className="hidden md:flex items-center gap-3">
              <a
                href="tel:+46722339379"
              ...
              <a
                href="#kontakt"
                className="inline-flex items-center rounded-2xl border px-4 py-2 text-sm font-medium hover:shadow"
              >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-5 text-lg text-neutral-600 max-w-prose">
                Jag hjälper privatpersoner och företag med kompletta
                bygglovsritningar för nybyggnad, tillbyggnad och ombyggnad –
                från första skiss till färdiga handlingar enligt kommunens krav.
              </p>
        ...
        <section id="tjanster" className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-2 text-neutral-600 max-w-prose">
              Kompletta handlingar enligt Boverkets och kommunens krav. Leverans
              som PDF och DWG vid behov.
            </p>
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={s.title}
                  className="rounded-2xl border bg-neutral-50 p-6 hover:shadow-sm"
                >
              ...
              {[
                {
                  ...
                  desc: "Vi går igenom ditt projekt, detaljplan och kommunens krav.",
                },
                {
                  step: "2",
                  title: "Offert & fast pris",
                  desc: "Du får fast pris och preliminär tidplan för leverans.",
                },
                {
                  step: "3",
                  title: "Ritningsframtagning",
                  desc: "Du får utkast för synpunkter tills allt känns rätt.",
                },
                {
                  step: "4",
                  title: "Leverans & bygglov",
                  desc: "Färdiga handlingar för digital ansökan till kommunen.",
                },
              ].map((p) => (
                <li key={p.step} className="rounded-2xl border bg-white p-6">
                  <div className="w-9 h-9 rounded-full bg-black text-white grid place-items-center font-semibold">
                    {p.step}
                  </div>
        ...
        <section id="priser" className="py-16 bg-neutral-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-2 text-neutral-600 max-w-prose">
              Fast pris efter genomgång av ditt projekt. Nedan typiska spann
              inkl. 25% moms.
            </p>
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {[
                {
                  title: "Attefall & fasadändring",
                  price: "4 900 – 8 900 kr",
                  includes: [
                    "Plan, fasad, sektion",
                    "Enkel kontrollplan",
                    "PDF-leverans",
                ...
                {
                  title: "Nybyggnad villa/garage",
                  price: "16 900 – 29 900 kr",
                  includes: [
                    "Nybyggnadskarta (underlag)",
                    "Kompletta ritningar",
                    "Stöd vid ansökan",
                  ],
                },
                ...
                >
                  ...
                  <a
                    href="#kontakt"
                    className="mt-6 inline-flex items-center justify-center rounded-xl bg-black text-white px-5 py-3 font-medium hover:opacity-90"
                  >
                    Begär offert
                  </a>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="mt-4 text-neutral-700 leading-relaxed">
                Jag heter <span className="font-medium">Sara Osman</span> och
                hjälper dig att få bygglovsritningar som uppfyller både
                Boverkets byggregler och kommunens lokala riktlinjer. Jag
                arbetar effektivt och kommunikativt – du får snabba svar och
                tydliga utkast tills allt känns rätt.
              </p>
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-xs text-neutral-500 mt-2">
                Ersätt platsbilden med porträtt/foto.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="md:col-span-2 rounded-2xl border bg-white p-6">
                ...
                >
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <input
                      className="mt-1 w-full rounded-xl border px-3 py-2"
                      placeholder="T.ex. tillbyggnad av villa i Mora"
                    />
                  </div>
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      ...
                      placeholder="Beskriv kort vad du vill bygga"
                    />
                  </div>
                  <div className="sm:col-span-2 flex items-center justify-between">
                    ...
                    <a
                      href="mailto:kontakt@saraosman.se"
                      className="inline-flex items-center rounded-2xl bg-black text-white px-5 py-3 font-medium hover:opacity-90"
                    >
                      Skicka förfrågan
                    </a>
                  </div>
              ...
              <aside className="rounded-2xl border bg-white p-6">
                ...
                <ul className="mt-3 text-sm text-neutral-700 space-y-1">
                  <li>
                    ...
                    <a
                      className="underline"
                      href="mailto:bygglovsritningar.sara@gmail.com"
                    >
                      bygglovsritningar.sara@gmail.com
                    </a>
                  </li>
                  <li>
                    Telefon:{" "}
                    <a className="underline" href="tel:+46722339379">
                      072-233 93 79
                    </a>
                  </li>
                ...
                <div className="mt-6 rounded-xl bg-neutral-50 p-4 text-sm text-neutral-600">
                  ...
                  <p>
                    Skicka ditt underlag (skisser/foton) via e-post så kan vi
                    ofta ge preliminärt pris samma dag.
                  </p>
                </div>
              </aside>
            </div>
            ...
            <div className="rounded-3xl border bg-black text-white p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                ...
                <p className="text-neutral-300 mt-2">
                  Boka ett kort uppstartsmöte så tar vi fram en offert med fast
                  pris.
                </p>
              </div>
              <div className="flex gap-3">
                <a
                  href="tel:+46722339379"
                  className="rounded-2xl bg-white text-black px-6 py-3 font-medium hover:opacity-90"
                >
                  Ring Sara
                </a>
                <a
                  href="mailto:bygglovsritningar.sara@gmail.com"
                  className="rounded-2xl border border-white px-6 py-3 font-medium hover:bg-white hover:text-black"
                >
                  Maila
                </a>
              </div>
        ...
        <footer className="border-t">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-sm text-neutral-600 grid md:grid-cols-3 gap-6 items-start">
            <div>
              <p className="font-medium text-neutral-900">
                Sara Osman – Bygglovsritningar
              </p>
              <p className="mt-2">
                Professionella ritningar för bygglov och anmälan. Snabbt, tryggt
                och prisvärt.
              </p>
            </div>
            <div>
              ...
              <ul className="mt-2 space-y-1">
                ...
                <li>
                  <a className="hover:underline" href="#priser">
                    Priser
                  </a>
                </li>
                <li>
          ...
          <div className="text-center text-xs text-neutral-500 pb-8">
            © {new Date().getFullYear()} Sara Osman. Alla rättigheter
            förbehållna.
          </div>
        </footer>
      </main>
